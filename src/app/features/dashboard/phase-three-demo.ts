...
export const demoKnowledgeDocs: EmsKnowledgeBaseDoc[] = [
  {
    ...
    title: 'EMS aspects and impacts register',
    storageRef: `tenants/${demoTenantId}/auditees/${demoAuditeeId}/ems/aspects-register.pdf`,
    status: 'embedded',
    embeddingNamespace: `${demoTenantId}:${demoAuditeeId}:ems`,
    chunkCount: 42,
  ...
  },
  {
    ...
    tenantId: demoTenantId,
    auditeeId: demoAuditeeId,
    title: 'Environmental objectives tracker',
    storageRef: `tenants/${demoTenantId}/auditees/${demoAuditeeId}/ems/objectives-tracker.xlsx`,
    status: 'embedded',
    embeddingNamespace: `${demoTenantId}:${demoAuditeeId}:ems`,
    chunkCount: 18,
  ...
  citations: [
    {
      ...
      chunkId: 'chunk-7',
      sourceTitle: 'Environmental objectives tracker',
      storageRef: `tenants/${demoTenantId}/auditees/${demoAuditeeId}/ems/objectives-tracker.xlsx`,
      relevanceScore: 0.91,
    },
    {
      ...
      chunkId: 'chunk-12',
      sourceTitle: 'EMS aspects and impacts register',
      storageRef: `tenants/${demoTenantId}/auditees/${demoAuditeeId}/ems/aspects-register.pdf`,
      relevanceScore: 0.84,
    },
  ],
...
export const demoEmsAnswer: EmsQuestionAnswer = {
  ...
  answer:
    'The uploaded tracker and aspects register indicate the audit team should sample objective updates, responsible owners, and the linked aspect records before confirming transition readiness.',
...
export const demoLineOfInquiry: LineOfInquiryPrompt[] = [
  {
    ...
    prompt: 'Ask the process owner to show how current environmental objectives link to the latest aspect review.',
    rationale: 'The retrieved tracker and aspects register should connect planning records to field controls.',
    citations: demoRagResult.citations,
    status: 'needsAuditorReview',
  },
];
...
export const demoTransitionGap: TransitionGapCandidate = {
  ...
  tenantId: demoTenantId,
  auditeeId: demoAuditeeId,
  fromEdition: 'ISO_14001_2015',
  toEdition: 'ISO_14001_2026',
  clauseRef: {
    standard: 'ISO_14001',
    edition: 'ISO_14001_2026',
    clauseId: '6',
  ...
  evidenceNeeded: ['Current objective tracker', 'Aspect review record', 'Owner interview notes'],
  citations: demoRagResult.citations,
  status: 'needsAuditorReview',
};
...
export const demoPhotoAiAnalysis: PhotoAiAnalysis = {
  ...
  storageRef: `tenants/${demoTenantId}/audits/${demoAuditId}/evidence/photos/secondary-containment.webp`,
  ...
  observations: [
    {
      label: 'Secondary containment area',
      confidence: 0.82,
      signal: 'secondaryContainment',
      rationale: 'The image appears to show a contained storage area that should be verified in field context.',
    },
  ],
  detectedText: ['containment'],
  findingCandidates: [
    {
      summary: 'Verify secondary containment condition and inspection records.',
      suggestedType: 'ofi',
      suggestedSeverity: 'opportunity',
      clauseSuggestions: [
        {
