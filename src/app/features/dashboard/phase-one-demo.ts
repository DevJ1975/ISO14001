...
export const demoChecklistTemplate: ChecklistTemplate = {
  ...
  tenantId: demoTenantId,
  name: 'ISO 45001 transition readiness',
  ...
  items: [
    ...
    },
    {
      ...
      evidencePrompts: [
        { id: 'evidence-objectives', label: 'Current OH&S objectives', required: true },
...
export const demoAuditSetup: AuditSetupCommand = {
  ...
  templateId: 'template-transition-readiness',
  criteria: 'ISO_45001_2026',
  scope: 'Denver Assembly Plant occupational health & safety management system transition readiness audit.',
  objectives: [
    'Verify transition readiness for the selected OH&S management system scope.',
